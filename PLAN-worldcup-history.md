...
- [ ] Task 2: Xây dựng component `TimelineList.vue` - trục thời gian dọc để người dùng cuộn xem danh sách các năm tổ chức.
- [ ] Task 3: Xây dựng component `TournamentCard.vue` - hiển thị chi tiết thông tin khi người dùng tập trung vào một năm cụ thể (hiển thị cờ, tỉ số, cầu thủ nổi bật).
