...
<template>
  <div class="py-12 px-4 max-w-6xl mx-auto">
    ...
    <!-- Dream Team Lineup -->
    <div class="mb-16">
      <div class="inline-block bg-fuchsia-500 text-white font-black px-5 py-2 rounded-full mb-8 text-sm uppercase tracking-widest shadow-[0_0_20px_rgba(217,70,239,0.5)]">
