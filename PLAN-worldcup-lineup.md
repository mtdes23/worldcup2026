...
- [x] Task 3: Phát triển UI Sân bóng (Pitch Diagram) và tính năng chọn cầu thủ vào vị trí sơ đồ (VD: 4-3-3, 4-2-3-1) → Verify: Cầu thủ hiển thị đúng vị trí trên sân cỏ.
- [x] Task 4: Xây dựng tính năng Lưu/Tải lịch sử đội hình bằng LocalStorage → Verify: F5 tải lại trang, đội hình cũ vẫn được phục hồi.
- [x] Task 5: Tích hợp chức năng Xuất Ảnh (Export to Image) với Watermark "Designed by mtdes23 | www.mtdes23.id.vn" → Verify: Bấm nút "Share", tải xuống thành công ảnh PNG rõ nét.

## Done When
- [x] Ứng dụng chạy mượt mà trên cả Mobile và Desktop.
- [x] Người dùng chọn sơ đồ, ghép đủ 11 người, lưu lại thành công và xuất ra ảnh hoàn chỉnh có bản quyền của tác giả.
